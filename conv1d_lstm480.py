...
def get_samples(path, path2, day_begin, day_end, time_step):
    ...
    np.save('/data/nvme/yingda/x_6_2000', X)
    np.save('/data/nvme/yingda/y_6_2000', Y)
...
if __name__ == '__main__':
    ...
    # codes = read_day_universe_stock(20190301, 20190630)
    # print(codes)

    generator = generate_arrays_from_files(path, path2, 20190401, 20190531, 5)
    conv_lstm = conv1D_lstm_model()
    conv_lstm.establish(5, 480, 28, 0)
    conv_lstm.train(generator)
    test_x = list(np.load('/data/nvme/yingda/x_6_2000.npy'))
    test_y = np.load('/data/nvme/yingda/y_6_2000.npy')[:, 4, 0]
    pred_y = conv_lstm.predict(test_x)[:, 4, 0]
    p1, p2 = cal_corr(test_y, pred_y)
    print(str(20190401)+' and '+str(20190531))
    print("batchsize:512, tick:480, predict:top2000")
    print(p1, p2)
